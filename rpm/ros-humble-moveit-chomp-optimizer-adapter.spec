...
Name:           ros-humble-moveit-chomp-optimizer-adapter
Version:        100.0.0
Release:        1%{?dist}%{?release_suffix}
Summary:        ROS moveit_chomp_optimizer_adapter package

License:        BSD
Source0:        %{name}-%{version}.tar.gz

Requires:       ros-humble-chomp-motion-planner
Requires:       ros-humble-moveit-common
Requires:       ros-humble-moveit-core
Requires:       ros-humble-pluginlib >= 1.11.2
Requires:       ros-humble-ros-workspace
BuildRequires:  ros-humble-ament-cmake
BuildRequires:  ros-humble-chomp-motion-planner
...
%changelog
* Thu Jul 07 2022 Raghavender Sahdev <raghavendersahdev@gmail.com> - 100.0.0-1
